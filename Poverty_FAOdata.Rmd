...
An interesting aspect of AMD01, is that there appears to be a large seperation in MPI based on teh fraction of the production that is capture, where the higher fraction of capture appears to be correlated with higher MPI. 
