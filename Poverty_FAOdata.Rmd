...
```{r FAO_import}
# box_auth(client_id = "hdinb450zm70jf7nh37tvkhnqmdu1x46", client_secret = "****")
# Get secret from: https://app.box.com/developers/console/app/1643820/configuration
# Andy's Box app : adeinesbox
boxr::box_fresh_auth()
box_ls("149328113696")
FAO_capture<-box_read_csv(file_id="880355334542")

  
  read.csv("https://tnc.box.com/s/62wp8s4y6q27efbmi834hzgj916lmvlg")
